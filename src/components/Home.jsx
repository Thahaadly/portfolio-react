      ...
      <main className="max-w-[1440px] mx-auto">
        ...
        <section className="pt-24 md:pt-[120px] pb-16 px-6 flex flex-col items-center text-center">
          ...
          <p className="text-[16px] md:text-[18px] text-[#212121] max-w-2xl mb-10 leading-[1.5]">
            Fullstack Web Developer based in Banjarmasin. Merangkai antarmuka pengguna yang memukau dengan backend, database, dan API yang andal.
          </p>
          
          <div className="flex items-center gap-6">
            <a 
              href="/CV-Thaha-Wafiq-Adly.pdf" download="CV_Thaha_Wafiq_Adly.pdf"
            ...
            <a 
              href="https://github.com/Thahaadly" target="_blank" rel="noreferrer"
          ...
          <div className="flex flex-col md:flex-row gap-6 h-auto md:h-[600px]">
            ...
            <div className="flex-grow bg-[#17171c] text-white rounded-[22px] p-8 md:p-12 relative overflow-hidden flex flex-col shadow-sm border border-[#212121]">
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="font-mono uppercase text-[12px] tracking-[0.28px] text-[#93939f] ml-2">~/portfolio/thaha.sh</span>
              </div>
            ...
            <div className="w-full md:w-[400px] lg:w-[480px] bg-[#eeece7] rounded-[22px] p-8 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/thahaa/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-white border border-[#d9d9dd] text-[#17171c] px-4 py-2 rounded-full text-[14px] font-medium hover:border-[#17171c] transition-colors">
                    <FaLinkedin className="text-[#1863dc]" /> Connect on LinkedIn
                  </a>
                </div>
              </div>
            </div>
        ...
        <section className="py-[80px] px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-60 hover:opacity-100 grayscale hover:grayscale-0 transition-all duration-500">
            <div className="flex items-center gap-3 text-[24px] font-bold text-[#212121]"><FaReact className="text-3xl text-emerald-500" /> React JS</div>
            <div className="flex items-center gap-3 text-[24px] font-bold text-[#212121]"><FaLaravel className="text-3xl text-rose-500" /> Laravel</div>
            <div className="flex items-center gap-3 text-[24px] font-bold text-[#212121]"><SiMysql className="text-3xl text-cyan-600" /> MySQL</div>
            <div className="flex items-center gap-3 text-[24px] font-bold text-[#212121]"><FaPython className="text-3xl text-yellow-500" /> Python</div>
          </div>
        </section>
          ...
          <div className="bg-[#003c33] text-white rounded-[22px] py-[80px] px-8 md:px-16 flex flex-col lg:flex-row items-start justify-between gap-12">
            <div className="max-w-xl">
              ...
              <p className="text-[18px] text-[#edfce9]/80 leading-[1.4] mb-8">
                From pixel-perfect React interfaces to robust Laravel APIs and Python data analytics, I build complete systems that scale gracefully.
              </p>
              <button onClick={() => window.location.href='#portfolio'} className="bg-white text-[#003c33] px-6 py-3 rounded-full text-[14px] font-medium hover:bg-[#edfce9] transition-colors">
                View Portfolio
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full lg:w-1/2">
              <div className="bg-black/20 border border-white/10 rounded-[16px] p-6 backdrop-blur-sm">
                ...
                <p className="text-[#edfce9]/60 text-[16px] leading-[1.5]">Membangun antarmuka dinamis dengan React JS dan Tailwind CSS. Fokus pada UX yang mulus dan clean code.</p>
              </div>
              <div className="bg-black/20 border border-white/10 rounded-[16px] p-6 backdrop-blur-sm">
                <div className="w-10 h-10 border border-white/20 rounded-[8px] mb-6 flex items-center justify-center text-[#edfce9]">
                ...
                <p className="text-[#edfce9]/60 text-[16px] leading-[1.5]">Merancang REST API aman dan arsitektur database MySQL yang efisien menggunakan framework PHP modern.</p>
              </div>
            </div>
          </div>
        </section>
