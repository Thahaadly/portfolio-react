  ...
  const experiences = [
    {
      ...
      description:
        "Lulusan dengan pemahaman kuat di bidang pengembangan perangkat lunak. Menyelesaikan tugas akhir berfokus pada Machine Learning (K-Means Clustering) untuk analisis data performa olahraga.",
      icon: (
        <img
          src={ulmLogo}
          alt="ULM Logo"
    ...
    },
    {
      ...
      description:
        "Lulus dengan skor 90/100. Membangun 4 proyek aplikasi (E-Commerce, Portal Berita, Web Movie, Mobile Hotel) secara end-to-end dengan implementasi REST API, arsitektur component-based, dan React Hooks.",
      icon: (
        <img
          src={hacktiv8Logo}
          alt="Hacktiv8 Logo"
    ...
    },
    {
      ...
      description:
        "Sertifikasi kompetensi nasional yang memvalidasi keahlian praktis dalam mengoperasikan perangkat lunak Microsoft Office (Word, Excel, PowerPoint) untuk administrasi dan pengolahan data.",
      icon: (
        <img
          src={bnspLogo}
          alt="BNSP Logo"
  ...
  return (
    <div className="w-full flex flex-col pt-2">
      ...
      <div className="flex items-center gap-4 mb-8 border-b border-[#e5e7eb] pb-4">
        ...
        <div>
          <h3 className="text-[24px] font-bold text-[#17171c] tracking-tight">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
        {experiences.map((exp, index) => {
          return (
            <div
              key={index}
              className="rounded-[22px] p-6 border border-transparent flex flex-col h-full bg-gradient-to-br from-[#182c3c] via-[#4d6978] to-[#d9c8b3] shadow-lg transition-transform duration-300 hover:-translate-y-1 relative group overflow-hidden animate-fade-in"
              style={{
            ...
            >
              ...
              <div className="flex flex-col flex-grow border-t border-[#ffffff]/20 pt-5 relative z-10">
                <h4 className="text-[18px] font-medium text-[#ffffff] mb-1 tracking-tight leading-tight">
                  {exp.title}
                </h4>
                <p className="text-[13px] font-bold mb-4 text-[#e5e5e5]">
                  {exp.subtitle}
                </p>
                <div className="text-[13px] text-[#f3f4f6] leading-relaxed mt-auto">
                  {exp.description}
                </div>
              </div>
            </div>
