...
export default function ContactSection() {
  ...
  const onSubmit = async (event) => {
    ...
    toast.promise(
      ...
      }),
      {
        ...
        error: (err) =>
          `Gagal mengirim pesan: ${err.message || "Periksa koneksi Anda."}`,
      },
    );
  ...
  return (
    <section
      id="contact"
      className="w-full flex flex-col pb-24 md:pb-32 pt-0 mb-10"
    >
      <div className="w-full max-w-6xl mx-auto px-6 lg:px-4">
        ...
        <div className="flex flex-col gap-6 mb-16 text-center md:text-left">
          ...
          <p className="text-[18px] md:text-[20px] text-[#616161]">
            Mari berdiskusi tentang peluang kolaborasi.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-6 order-1 lg:order-2">
            <a
              href="mailto:thahaadly6@gmail.com"
              aria-label="Kirim Email"
              className="flex items-center gap-6 p-8 rounded-[22px] bg-gradient-to-br from-[#182c3c] via-[#4d6978] to-[#d9c8b3] border border-transparent shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden group"
            >
              <div className="absolute inset-0 bg-[#000000] opacity-[0.05] mix-blend-multiply pointer-events-none"></div>
              <div className="relative z-10 flex items-center gap-6 w-full">
                ...
                <div>
                  <h3 className="font-bold text-[20px] text-[#ffffff] mb-1">
                    Email
                  </h3>
                  <span className="text-[15px] font-semibold text-[#f3f4f6]">
                    thahaadly6@gmail.com
                  </span>
                </div>
              </div>
            </a>
            ...
            <a
              href="https://wa.me/6289618687992"
              target="_blank"
              rel="noopener noreferrer"
